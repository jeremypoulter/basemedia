...
{
    /// <summary>
    /// Store Country Code Atom ("sfID")
    /// </summary>
    [Box("sfID", "Store Country Code Atom")]
    public class StoreCountryCodeBox : Box, ISuperBox
    {
        public StoreCountryCodeBox() : base() { }
        public StoreCountryCodeBox(Stream stream) : base(stream) { }
