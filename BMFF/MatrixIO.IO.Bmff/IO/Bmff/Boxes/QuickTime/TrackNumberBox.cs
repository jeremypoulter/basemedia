...
{
    /// <summary>
    /// Track Number Atom ("trkn")
    /// </summary>
    [Box("trkn", "Track Number Atom")]
    public class TrackNumberBox : Box, ISuperBox
    {
        public TrackNumberBox() : base() { }
        public TrackNumberBox(Stream stream) : base(stream) { }
