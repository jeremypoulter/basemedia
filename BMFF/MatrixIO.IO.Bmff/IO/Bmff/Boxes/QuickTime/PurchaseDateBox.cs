...
{
    /// <summary>
    /// Purchase Date Atom ("purd")
    /// </summary>
    [Box("purd", "Purchase Date Atom")]
    public class PurchaseDateBox : Box, ISuperBox
    {
        public PurchaseDateBox() : base() { }
        public PurchaseDateBox(Stream stream) : base(stream) { }
