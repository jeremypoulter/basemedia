...
{
    /// <summary>
    /// Store Account Type Atom ("akID")
    /// </summary>
    [Box("akID", "Store Account Type Atom")]
    public class StoreAccountTypeBox : Box, ISuperBox
    {
        public StoreAccountTypeBox() : base() { }
        public StoreAccountTypeBox(Stream stream) : base(stream) { }
