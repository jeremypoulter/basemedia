...
{
    /// <summary>
    /// Standard Genre Atom ("gnre")
    /// </summary>
    [Box("gnre", "Standard Genre Atom")]
    public class StandardGenreBox : Box, ISuperBox
    {
        public StandardGenreBox() : base() { }
        public StandardGenreBox(Stream stream) : base(stream) { }
