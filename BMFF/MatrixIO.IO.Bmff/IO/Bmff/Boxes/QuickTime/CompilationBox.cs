...
{
    /// <summary>
    /// Compilation Atom ("cpil")
    /// </summary>
    [Box("cpil", "Compilation Atom")]
    public class CompilationBox : Box, ISuperBox
    {
        public CompilationBox() : base() { }
        public CompilationBox(Stream stream) : base(stream) { }
