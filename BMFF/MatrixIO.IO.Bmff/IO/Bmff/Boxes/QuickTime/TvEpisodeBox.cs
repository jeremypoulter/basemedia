...
{
    /// <summary>
    /// Tv Episode Atom ("tves")
    /// </summary>
    [Box("tves", "Tv Episode Atom")]
    public class TvEpisodeBox : Box, ISuperBox
    {
        public TvEpisodeBox() : base() { }
        public TvEpisodeBox(Stream stream) : base(stream) { }
