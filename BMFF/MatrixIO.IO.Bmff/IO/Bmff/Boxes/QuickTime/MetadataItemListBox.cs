...
namespace MatrixIO.IO.Bmff.Boxes
{
    ...
    /// </summary>
    [Box("ilst", "Metadata Item List Atom")]
    public class MetadataItemListBox : Box, ISuperBox
    {
        public MetadataItemListBox() : base() { }
        public MetadataItemListBox(Stream stream) : base(stream) { }
