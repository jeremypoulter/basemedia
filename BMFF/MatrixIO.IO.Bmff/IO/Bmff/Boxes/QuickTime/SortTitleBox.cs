...
{
    /// <summary>
    /// Sort Title Atom ("sonm")
    /// </summary>
    [Box("sonm", "Sort Title Atom")]
    public class SortTitleBox : Box, ISuperBox
    {
        public SortTitleBox() : base() { }
        public SortTitleBox(Stream stream) : base(stream) { }
